...
class NestedUNet(nn.Module):
    def __init__(self, deepsupervision, n_channels, n_classes, bilinear=False):
        super().__init__()
        ...
        self.conv0_0 = DoubleConv(self.n_channels , nb_filter[0])
...
if __name__ == '__main__':
    ...
    model = NestedUNet(deepsupervision, 3, 1)
    # m = model(torch.rand((1, 3, 960, 640)))
    # print(m.shape)
    rand_t = torch.rand((1, 3, 960, 640))
