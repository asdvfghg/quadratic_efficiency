...
class Unet(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.up6 = nn.ConvTranspose2d(512, 256, 3, stride=1)
        self.conv6 = DoubleConv(512, 256)
        self.up7 = nn.ConvTranspose2d(256, 128, 3, stride=1)
        self.conv7 = DoubleConv(256, 128)
        self.up8 = nn.ConvTranspose2d(128, 64, 3, stride=1)
        self.conv8 = DoubleConv(128, 64)
        self.up9 = nn.ConvTranspose2d(64, 32, 3, stride=1)
